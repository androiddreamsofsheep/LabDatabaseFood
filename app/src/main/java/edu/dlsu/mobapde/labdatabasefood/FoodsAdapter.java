...
public class FoodsAdapter
        extends CursorRecyclerViewAdapter<FoodsAdapter.ViewHolder> {

    private OnItemClickListener onItemClickListener;

    public FoodsAdapter(Context context, Cursor cursor) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Cursor cursor) {
        ...
        long id = cursor.getLong(cursor.getColumnIndex(Food.COLUMN_ID));
